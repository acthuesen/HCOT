###Older versions of cosmed device create .xls files which can't be loaded via pandas because of an encoding error
#A workaround that works is to load files using xlrd, save a temp copy and load that in pandas
...
csv_fd = open(os.path.join(d, 'csv_fd.csv'), 'w', newline='')
